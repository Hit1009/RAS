	...
	return (
		...
		<div id="Events">
			<div className="py-20">
				{/* heading */}
				<p
					className="text-white text-4xl sm:text-5xl lg:text-7xl ml-[10%]"
				>
					<span className="text-white underline-offset-2">Upcoming </span>
					<span className="text-[#0073AE]">Events</span>
					<span className="text-white">.</span>
					<hr className="w-[19%] md:w-[14%] lg:w-[16%] xl:w-[11%] mt-5 mb-10 h-1 rounded-lg border-0 bg-[#0073AE]" />
				</p>
				{/* Main Event */}

				<div id="card" className=" mt-10 md:mt-14 mx-4 md:mx-20 ">
