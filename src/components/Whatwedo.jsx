...
function WhatweDo() {
  return (
    <div id="parent" className="flex h-screen overflow-y-hidden">
      ...
      <div className="absolute left-[35%] top-[150%] w-[10%] h-60 -mt-60 bg-gradient-to-r from-[#F4C4F3] to-[#FFF] filter blur-[180px] rounded-full transform rotate-90"></div>
        ...
        <div className="absolute right-[10%] top-500 w-40 h-40 bg-gradient-to-r from-[#F4C4F3] to-[#FC67FA] filter blur-[150px] rounded-full rounded-full"></div>
